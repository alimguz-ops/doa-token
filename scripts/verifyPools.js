...
async function main() {
  ...
  for (const pair of pairs) {
    try {
      ...
      console.log(`❌ Error verificando ${pair.tokenA}/${pair.tokenB}:`, err.message);
    }
  }
}
