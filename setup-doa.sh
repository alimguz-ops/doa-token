...
mkdir -p DOA-TOKEN/apps/web/public/brand/doa
mkdir -p DOA-TOKEN/.github/workflows
mkdir -p DOA-TOKEN/apps/web/src/components

# Crear archivo doa.svg
cat > DOA-TOKEN/apps/web/public/brand/doa/doa.svg << 'EOF'
...
# Crear variantes vacías (rellena con el contenido que ya te pasé antes)
touch DOA-TOKEN/apps/web/public/brand/doa/doa-dark.svg
touch DOA-TOKEN/apps/web/public/brand/doa/doa-flat.svg
touch DOA-TOKEN/apps/web/public/brand/doa/doa-mask.svg

# Crear workflow brand.yml
cat > DOA-TOKEN/.github/workflows/brand.yml << 'EOF'
...
# Crear componente React TokenLogo.tsx
cat > DOA-TOKEN/apps/web/src/components/TokenLogo.tsx << 'EOF'
