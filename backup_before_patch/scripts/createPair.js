// scripts/autoLiquidity.js (ESM + ethers v6)
...
async function main() {
  ...
  console.log("\n🔎 Flujo automático: crear par + añadir liquidez + actualizar config...\n");
  ...
  console.log("✅ Tokens aprobados. TX:", txApprove.hash);
...
main().catch((error) => {
  console.error("❌ Error en autoLiquidity.js:", error);
  process.exitCode = 1;
});